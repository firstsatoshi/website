...
func (m *defaultTbBlindboxEventModel) Insert(ctx context.Context, data *TbBlindboxEvent) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.EventName, data.EventDescription, data.PriceSats, data.IsActive, data.PaymentToken, data.AverageImageBytes, data.Supply, data.Avail, data.LockCount, data.MintLimit, data.OnlyWhitelist, data.StartTime, data.EndTime)
	}, tbBlindboxEventIdKey)
	return ret, err
}
...
func (m *defaultTbBlindboxEventModel) Update(ctx context.Context, data *TbBlindboxEvent) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.EventName, data.EventDescription, data.PriceSats, data.IsActive, data.PaymentToken, data.AverageImageBytes, data.Supply, data.Avail, data.LockCount, data.MintLimit, data.OnlyWhitelist, data.StartTime, data.EndTime, data.Id)
	}, tbBlindboxEventIdKey)
	return err
}
